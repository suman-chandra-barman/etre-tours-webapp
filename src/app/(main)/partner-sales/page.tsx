...
export default function OperationsBoardPage() {
  ...
  const [partnerSalesTours, setPartnerSalesTours] = useState<OperationsTour[]>([
    ...
    },
    {
      ...
      returnDate: "2026-03-12",
      returnTime: "13:00",
      tourName: "Sunset ridge",
      tourCode: "SUN001",
      status: tourStatus.PRE_DEPARTURE,
      transportType: "bus",
      transportContractor: "Blue horizon",
      vehicleNumber: "334455",
      seatsSold: 10,
      seatsAvailable: 5,
      numberOfSeats: 15,
      driver: "Alice Monroe",
    ...
    },
    {
      ...
      returnDate: "2026-03-12",
      returnTime: "17:00",
      tourName: "Waterfall trek",
      tourCode: "WAT001",
      status: tourStatus.PRE_DEPARTURE,
      transportType: "bus",
      transportContractor: "Green valley tours",
      vehicleNumber: "667788",
      seatsSold: 8,
      seatsAvailable: 7,
      numberOfSeats: 15,
      driver: "Tom Harris",
