...
interface PrintPartnerInvoiceModalProps {
  isOpen: boolean;
  onClose: () => void;
  ticketData: {
    dateOfIssue: string;
...
const PrintPartnerInvoiceModal = ({
  isOpen,
  onClose,
  ticketData,
}: PrintPartnerInvoiceModalProps) => {
        ...
        <div className={`${styles.printArea} p-8`}>
          ...
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="text-right">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">SELF BILLING INVOICE</h2>
...
export default PrintPartnerInvoiceModal;
