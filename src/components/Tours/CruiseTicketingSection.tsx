  ...
  const handleConfirm = () => {
    ...
    if (onConfirm) {
      onConfirm({
        ...
        infant: totalInfant,
        foc: totalFoc,
        shipProvided: ticketData.shipProvided,
        found: tourTotalPassengers,
        total,
      });
    }
  };
      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            ...
            {/* Total Ship provided */}
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Ship provided:</span>
              <span className="font-medium">
                {ticketData.shipProvided} passengers
              </span>
            </div>
            ...
            {tourTotalPassengers > 0 && (
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">
                  {tourTotalPassengers} passengers
                </span>
              </div>
            )}
